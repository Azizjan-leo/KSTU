    ...
    private void RunActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RunActionPerformed
        if(TextField.getText() != ""){
                if(Encrypt.isSelected()){ //if encrypt choosed
                    ...
                    TextField.setText(Encryption.Methods.Vigenere(TextField.getText(), key.getText(), "CYR", true));
                    else
                    TextField.setText(Encryption.Methods.Vigenere(TextField.getText(), key.getText(), "LAT", true));
                }else{ //if decryption choosed
                    if(CYR.isSelected() == true) //if cyr choosed call encryption method with cyrillic
                    TextField.setText(Encryption.Methods.Vigenere(TextField.getText(), key.getText(), "CYR", false));
                    else;
                    TextField.setText(Encryption.Methods.Vigenere(TextField.getText(), key.getText(), "LAT", false));
                }
        }
